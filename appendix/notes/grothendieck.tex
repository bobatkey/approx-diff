...
Suppose a functor $F: \cat{C} \to \Cat$. \todo{Actually conventional setup is with $F$ contravariant.} The
\emph{Grothendieck construction} $\Grothendieck{\cat{C}}F$ for $F$ is the category which has:
\begin{itemize}
