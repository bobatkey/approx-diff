...
(\secref{galois-slicing-auto-diff-via-grothendieck}):
   \begin{itemize}
      \item Galois slicing via $\Fam(\LatGal)$ (\secref{galois-slicing-auto-diff-via-grothendieck:galois-slicing})
      \item automatic differentiation via $\Fam(\FinVect)$ (\secref{galois-slicing-auto-diff-via-grothendieck:auto-diff})
   \end{itemize}
\end{itemize}
