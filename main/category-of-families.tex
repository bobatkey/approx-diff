...
\item \todo{Maybe unpack why these are true}
\begin{enumerate}
...
\begin{definition}[Vector space over $\RR$]
...
Up to isomorphism a finite-dimensional vector space over $\RR$ of dimension $n \in \Nat$ is the vector space
