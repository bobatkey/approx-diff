...
well as providing some substantiation to the claim that \GPS is a form of differentiation, this would also
clarify the role of higher derivatives in \GPS, which we conjecture are related to \emph{program
  differencing}.

% \subsection{Differential Linear Logic}

% Differential Linear Logic \cite{dill} is an extension of Linear Logic with a derivative operator that acts
% like
