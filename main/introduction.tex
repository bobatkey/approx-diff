...
called \GPS, where the forward and backward slicing procedures for a particular execution form a Galois
connection. Our main insight is that this approach to slicing can be seen as a generalised form of
differentiable programming, with approximations (slices) of elements playing the role of tangents.
