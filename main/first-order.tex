...
$\tangents(f) = x \mapsto (f(x), \pushf{f}_x): \RR^m \to \RR^n \times (\RR^m \linearto \RR^n)$. Writing $f_1$
for $\pi_1 \comp f$ and $f_2$ for $\pi_2 \comp f$, composition of such maps can be expressed as:
\begin{align*}
