...
between posets with a mapping from $\bot$ to $\bot$. $\mathcal{L}$ extends to strong monad $\mathcal{L}_\meet$
on meet-semilattices on $X$. For any join-semilattice on $X$, $\mathcal{L}$ induces a costrong comonad, as
