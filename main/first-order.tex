...
\begin{enumerate}
\item If $Z$ is a product of $X$ and $Y$ then it is also coproduct of $X$ and $Y$, with injections given by
$\inj_1 = \prodM{\id}{0}$ and $\inj_2 = \prodM{0}{\id}$.
\item If $Z$ is a coproduct of $X$ and $Y$, then it is also a product of $X$ and $Y$, with projections given by $\pi_1 =
