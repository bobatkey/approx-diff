...
\secref{introduction}. We might then interpret $+$ as the morphism $(+,\partial+)$, with $+$ here meaning the
usual addition operator, and $\partial+_{n,m}: \downset{n} \to \downset{m}$ defined as
\begin{displaymath}
