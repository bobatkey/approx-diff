...
category of commutative monoids, if every hom-set $\cat{C}(X,Y)$ has a similar additive structure, providing
an operation + to add morphisms together plus a zero morphism $0: X \to Y$, and if composition is
