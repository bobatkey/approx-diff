...
commutative monoid with an addition + and zero element 0. If this additive structure is also present in the
hom-sets $\cat{C}(X,Y)$ of a category, and composition preserves it, $\cat{C}$ is enriched in $\CMon$, the
