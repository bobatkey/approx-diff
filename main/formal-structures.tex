...
approximations of their inputs to approximations of their outputs. Since these lattices of approximations
...
construction and the idea of tangent spaces and derivatives. To understand how the $\partial X$ components
...
$f: X \to Y$ paired with morphisms $\partial f: \partial X \to \reindex{\partial Y}{f}$ in $\Fam(X,\cat{C})$.
