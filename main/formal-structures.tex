...
We take an approach based on the CHAD (Combinatory Homomorphic Automatic Differentiation) of Mattias Vákár and others~\cite{vákár22,nunes2023}. Here follows a rough overview of this approach and how we have applied it to \GPS.
