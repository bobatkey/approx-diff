...
As sketched in \secref{introduction:galois-slicing}, for Galois slicing we require a setting where the
...
to combine approximations. Thus rather than working in $\PosGal$, we define the following subcategory.
