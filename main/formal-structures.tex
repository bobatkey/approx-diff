...
category which sends any set $X$ to the functor category $\Func{X}{\cat{C}}$ and any function $f: X \to Y$ to
the reindexing functor $- \comp f: \Func{Y}{\cat{C}} \to \Func{X}{\cat{C}}$.
