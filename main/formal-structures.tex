...
objects of $\cat{C}$, and as morphisms from $X \to \cat{C}$ to $Y \to \cat{C}$, all natural transformations,
i.e.~families of morphisms $f_x: X_x \to Y_x$ in $\cat{C}$ for every $x \in X$.
\end{definition}
