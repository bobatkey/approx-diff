...
This setup is exactly the \emph{Grothendieck construction} for a particular indexed category over $\Set$, by
which we shall mean any \todo{(strict?)? functor $\Set^\op \to Cat$.
