...
\roly{Clarify $F$ here refers to \propref{ho-embedding} (esp.~as \thmref{glr-definability} quantifies over
arbitrary $F$), perhaps by giving it a more meaningful name}
...
\begin{proof}
  ...
  \propref{ho-embedding} we know that $F$ preserves finite products and
