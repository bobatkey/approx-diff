...
\roly{Give embedding $F$ a more specific name to clarify we're referring to \propref{ho-embedding} (esp.~as
\thmref{glr-definability} quantifies over arbitrary $F$)}
