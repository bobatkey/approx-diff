\section{Constructing Models of \GPS for a Total Language}
...
As we explained in \secref{stab}, L-posets can be seen as partially
...
in our definability proof in \secref{definability}, where we use a
...
this category satisfies the hypotheses of \thmref{fam-closed}:
