...
\bob{We don't get a theorem like ``if we didn't input $i$ to obtain
  the output, then we could replace it with any other value.'' How
  would we extend $\Fam(\LatGal)$ to do this?}
