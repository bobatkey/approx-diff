...
Suppose $\cat{C}$ a category with finite coproducts and finite products. Define $\muPoly$
to be the smallest subcategory of $\Cat$ closed under the rules in \figref{mu-polynomial}.
\end{definition}
