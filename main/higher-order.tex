...
Suppose $\cat{C}$ a Cartesian closed category with exponential $\internalHom{X}{Y}$, evaluation morphisms
...
\end{enumerate}
\figref{default-semantics:types} gives the interpretation of a type $\tau$ with a single free type variable as
