...
Although $\Fam(\FinVect)$ nor $\Fam(\LatGal)$ provide an appropriate notion of composition for automatic
differentiation and Galois slicing respectively, neither is Cartesian closed. Both are therefore unsuitable
for interpreting higher-order programs. However the following is a special case of a construction due to
\citet{nunes2023}:
