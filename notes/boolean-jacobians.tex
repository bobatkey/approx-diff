...
Let $\Two = (\{\bot, \top\}, \join, \bot, \meet, \top, \neg)$ be the two-element Boolean algebra. Write
$\SemiLat$ for the category of idempotent commutative monoids and monoid homomorphisms; it is
$\CMon$-enriched and has biproducts. $\SemiLat$ admits two forgetful functors to $\Poset$, according to
whether the monoid operation is read as a join or a meet; the two readings give dual posets. We adopt the
join reading notationally throughout.
