...
$\SemiLat$ for the category of (join) semilattices and $\join$-preserving maps; it is $\CMon$-enriched and
has biproducts. The two readings of $\SemiLat$ --- as join semilattices or as meet semilattices --- are
indistinguishable as categories; we adopt the join convention notationally throughout.
