...
x$ and $x + \varepsilon = x$ for any $x \in A$.
...
Although $\CMon$ is not Cartesian closed, every hom-object $\CMon(A,B)$ is a commutative monoid, with the
constant homomorphism that sends every element of the carrier of $A$ to $1_A$ as the unit, and pointwise
