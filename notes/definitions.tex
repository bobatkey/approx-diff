...
category. $\Fam(-,C): \Set^{\op} \to \Cat$ is the functor which sends any set $I$ to $\Fam(I,C)$ and any
...
The Grothendieck construction for a functor $F: D \to \Cat$ is the category where:
\begin{itemize}
\item objects are pairs $(I, X)$ of an object $I$ of $D$ and an object of $FI$;
\item morphisms from $(I, X)$ to $(J, Y)$ are morphisms $f: I \to J$ in $D$ paired with a morphism $(Ff)(X) \to Y$ in $FJ$.
\end{itemize}
