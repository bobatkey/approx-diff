...
A category is $\CMon$-enriched if $\Hom{A}{B}$ is closed under the \emph{zero} morphism $\zero_{A,B}$ and
addition of morphisms $+_{A,B}$ satisfying the commutative monoid laws.
