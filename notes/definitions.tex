...
Although $\CMon$ is not Cartesian closed, every hom-object $\CMon(A,B)$ is a commutative monoid, with unit
given by the constant homomorphism that sends every element of $A$ to $\varepsilon_B$, and binary operation
given by $(f + g)(a) = f(a) + f(b)$.
