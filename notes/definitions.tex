...
commutative monoid homomorphisms, with the trivial one-element monoid $\One$ as terminal object and binary
products $M \tensor M'$ given by the direct product of monoids.
