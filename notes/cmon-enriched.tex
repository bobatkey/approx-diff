...
\todo{Generalise to any monoidal closed $\mathscr{V}$ with biproducts?} The $\CMon$-enriched Yoneda embedding
preserves biproducts, where (as in any functor category) biproducts in $\PSh_{\CMon}(\cat{C})$ are computed
pointwise, and noting that $\CMon$ itself has biproducts.
