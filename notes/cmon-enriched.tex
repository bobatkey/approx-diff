\section{$\CMon$-enriched categories}
...
\subsection{$\CMon$-enriched presheaves}
...
\subsection{Enriched Yoneda embedding}
...
\roly{Generalise to any monoidal closed $\mathscr{V}$ with biproducts?} $\CMon$ is monoidal closed, and has
biproducts (\secref{categories-with-biproducts:cmon}) which are inherited pointwise into
