...
out of a free module as matrices. It is proved from the sum-of-basis lemma $\sum_j (e_i)_j \cdot f(j) =
f(i)$ together with the symmetry $(e_i)_j = (e_j)_i$ of the Kronecker $\delta$. When $S$ has a
...
sum-distributivity of $\cdot$ on both sides together with the interchange law $\sum_i \sum_j f(i)(j) =
