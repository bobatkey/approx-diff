...
Given any commutative semiring $S = (|S|, +, 0, \cdot, 1)$, let $\Mat(S)$ denote the category whose objects
are the natural numbers and whose morphisms $m \to n$ are $n \times m$ matrices over $S$. Composition is
matrix multiplication in $S$ and the identity $m \to m$ is the Kronecker $\delta$.
