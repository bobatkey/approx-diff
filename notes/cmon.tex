...
closed. \roly{But the monoidal product is not the Cartesian product?}

\subsection{Example of commutative monoid}
...
\noindent The meet and join readings each induce a forgetful functor $\SemiLat \to \Poset$, giving dual
posets on the same underlying set.
