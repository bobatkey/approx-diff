\section{Predicate systems}
\label{sec:predicate-system}

\subsection{Predicate system over $\cat{C}$}
...
\subsection{Predicate system over $\Set$}
...
\subsection{Predicates on a presheaf}
...
\subsection{Closure operator over a predicate system}
...
%
% \subsection{Coproduct closure operator}
%
