...
\inj_{\faml{X}_x}){,}\,\id_{\faml{Y}_y})"] \arrow[r, "\faml{f}_{x,y}"'] & \faml{Z}_{\idx{f}(x,y)}
\end{tikzcd}
\end{center}
...
\coprodM{\eval_{\prod_{y}}}{\faml{f}_{(x,y)}\,\comp\,\inj_{\faml{Y}_y}}
\comp
(\lambda_{\prod_{\idx{Y}}}(\reindex{\faml{f}}{{(x,-)}}\,\comp\,\inj_{\faml{X}_x}){,}\,\id_{\faml{Y}_y})
\\
&=&
\coprodM
   {\eval_{\prod_{y}} \comp \lambda_{\prod_{\idx{Y}}}(\reindex{\faml{f}}{{(x,-)}}\,\comp\,\inj_{\faml{X}_x})}
   {\faml{f}_{(x,y)}\,\comp\,\inj_{\faml{Y}_y} \comp \id_{\faml{Y}_y}}
\\
&=&
\coprodM
   {\faml{f}_{(x,y)}\,\comp\,\inj_{\faml{X}_x}}
