...
given by $(\prod,\eval,\lambda)$. For any objects $X = (I, X), Y = (J, Y)$ and $Z = (K, Z)$ in $\Fam(C)$
define:
...
\item $g' = \lambda(\{g_{i, j} \comp \inj_{X_i} \}_{i \in I})$ where $\inj_{X_i}: X_i \to X_i \biprod Y_j$
