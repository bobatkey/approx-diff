...
Suppose $C$ a $\CMon$-enriched category. \todo{I think we can also define ``biproduct'' using a universal
property and zero morphisms, which might be nicer as we can then derive rather than assume $\CMon$-enrichment.}
