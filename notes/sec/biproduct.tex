...
\begin{tikzcd}[row sep=3em, column sep=3em]
   & A \arrow[d, "\inj_A", shift left] \arrow[dr, "f_2"] \\
   A' \arrow[r, "\prodM{f_1}{g_1}"] \arrow[dr, "g_1"'] \arrow[ur, "f_1"] & A \biprod B \arrow[u, "\proj_A", shift left] \arrow[d, "\proj_B"', shift right] \arrow[r, pos=0.35, "\coprodM{f_2}{g_2}"] & B' \\
   & B \arrow[u, "\inj_B"', shift right] \arrow[ur, "g_2"']
\end{tikzcd}
\end{center}
\end{proposition}
