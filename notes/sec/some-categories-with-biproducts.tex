...
\item $(f \vdash g) + (f' \vdash g') = (f + f') \vdash (g + g'): X \to Y$.
\end{itemize}

\noindent and biadditivity of composition arising component-wise. Moreover $\LatGal$ has binary products, with
the product of Galois connections defined component-wise; it follows that $\LatGal$ has biproducts:
