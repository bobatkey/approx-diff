...
The internal hom $[(I, X), (J, Y)]$ is the object $(K,Z)$ in $\Fam(C)$ where $K$ is the set $\Fam(C)((I, X),
(J, Y))$ of morphisms from $\Fam(I,C)$ to $\Fam(J,C)$ and $Z$ is the $K$-indexed family in $\Fam(K,C)$ which
maps every $f: \Fam(I,C) \to \Fam(J,C)$ in K$ to .
