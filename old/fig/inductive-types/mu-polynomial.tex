...
\begin{subfigure}{\linewidth}
  ...
  \small
    ...
    {
      \prodM{F}{G} : \cat{E} \to \cat{D} \times \cat{D}' \in \Mor(\muPoly_{\cat{C}})
    }
    \and
    \inferrule*
    {
  ...
  \caption{Morphisms}
\end{subfigure}
\caption{$\mu$-polynomial functors, for a category $\cat{C}$ with finite coproducts and finite products
\roly{$\mu F$ is the functor induced by existence of $\mu(F(X,-))$ for every $X$, see \citet{nunes2023}
Proposition 4}}
