...
\item useful semi-additive categories (\secref{useful-semi-additive-categories}):
   ...
   \item category $\HeytConj$ of Heyting algebras and conjugate pairs
   (\secref{categories-with-biproducts:heytconj})
...
(\secref{galois-slicing-auto-diff-via-fam}):
   ...
   \end{itemize}
\item Boolean Jacobians: transpose and adjoint as De Morgan duals (\secref{boolean-jacobians})
