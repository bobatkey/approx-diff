...
%\geometry{paperwidth=8.3in, paperheight=11.7in}
...
\noindent Equivalently $\Fam(I,C)$ is the functor category $\FunCat{I}{C}$ where we interpret $I$ as a
discrete category.
...
join-semilattice homomorphisms $g: L' \to L$ satisfying $y \leq fx \iff gy \leq x$ for any $x \in L$ and any
$y \in L'$.
\end{itemize}
