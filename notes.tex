...
\noindent \note{The Agda defines an object of $\LatGal$ as a set equipped with meet- and join-semilattice
structures but there is no requirement that they satisfy the absorption laws or induce the same partial
order.}
